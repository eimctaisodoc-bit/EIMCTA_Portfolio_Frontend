...
import ModalGirl from '../../img/caller2.jpg'
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row max-w-7xl w-full h-full lg:min-h-[350px] lg:max-h-[650px]
     ...
     <div className="hidden lg:block lg:w-1/2 relative">
      ...
      />
      {/* Optional: Subtle overlay to make it blend with the brand */}
      ...
      <div className="absolute bottom-0 left-0 right-0 p-10 text-white">
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              <p className="text-amber-400 text-sm font-bold uppercase tracking-widest">Call Us Directly</p>
              <p className="text-2xl font-bold">+977 9766 561697</p>
            </div>
          </div>
        ...
        <main className="w-full lg:w-1/2 p-6 sm:p-8 md:p-10 lg:p-12 overflow-y-auto">
          <style>{`
